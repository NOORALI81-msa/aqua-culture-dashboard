...
def farmers():
    ...
    if request.method == 'POST':
        ...
        if request.form['doc']:
            try:
                doc_date = datetime.datetime.strptime(request.form['doc'], '%Y-%m-%d').date()
            except ValueError:
...
def sales():
    ...
    if request.method == 'POST':
        if form_type == 'dealer_sale':
            new_sale = Sale(
                employee_id=session['id'],
                dealer_id=request.form['dealer_id'],
                product_name=request.form['product_name'],
                packing=request.form['packing'],
                pacs_per_case=request.form['pacs_per_case'],
                mrp_per_pack=request.form['mrp_per_pack'],
    ...
    # A more complex query to get recent sales for both farmers and dealers
...
# ... (other routes like /employees, /profile, /logout are correct and don't need changes) ...
